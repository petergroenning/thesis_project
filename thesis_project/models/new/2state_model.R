...
makemodel <- function(type = 'basic', data = NULL){
    ...
    model$addSystem(dx1~dt/V1*((Tbot-x1)*FbotIn*exp(vbot)+(x2-x1)*(FbotOut*exp(f)))+dt*(y1-x1)*exp(mu_x)+dw1*exp(sigma_x))
    model$addSystem(dx2~dt/V2*((x1-x2)*(FbotIn*exp(f))+(x3-x2)*(FbotOut*exp(f)))+dt*(y2-x2)*exp(mu_x)+dw2*exp(sigma_x))
    model$addSystem(dx3~dt/V3*((x2-x3)*(FbotIn*exp(f))+(x4-x3)*(FbotOut*exp(f)))+dt*(y3-x3)*exp(mu_x)+dw3*exp(sigma_x))
    model$addSystem(dx4~dt/V4*((x3-x4)*(FbotIn*exp(f))+(x5-x4)*(FbotOut*exp(f))+(Tmid-x4)*FmidIn*exp(vmid))+dt*(y4-x4)*exp(mu_x)+dw4*exp(sigma_x))
    model$addSystem(dx5~dt/V5*((x4-x5)*(FtopOut*exp(f))+(x6-x5)*(FtopIn*exp(f)))+dt*(y5-x5)*exp(mu_x)+dw5*exp(sigma_x))
    model$addSystem(dx6~dt/V6*((x5-x6)*(FtopOut*exp(f))+(Ttop-x6)*FtopIn*exp(vtop))+dt*(y6-x6)*exp(mu_x)+dw6*exp(sigma_x))
    ...
    model$addSystem(dx1~dt/V1*((Tbot-x1)*FbotIn*exp(vbot)+(x2-x1)*(FbotOut*exp(fbot)))+dt*(y1-x1)*exp(mu_x)+dw1*exp(sigma_x))
    model$addSystem(dx2~dt/V2*((x1-x2)*(FbotIn*exp(f))+(x3-x2)*(FbotOut*exp(f)))+dt*(y2-x2)*exp(mu_x)+dw2*exp(sigma_x))
    model$addSystem(dx3~dt/V3*((x2-x3)*(FbotIn*exp(f))+(x4-x3)*(FbotOut*exp(f)))+dt*(y3-x3)*exp(mu_x)+dw3*exp(sigma_x))
    model$addSystem(dx4~dt/V4*((x3-x4)*(FbotIn*exp(f))+(x5-x4)*(FbotOut*exp(f))+(Tmid-x4)*FmidIn*exp(vmid))+dt*(y4-x4)*exp(mu_x)+dw4*exp(sigma_x))
    model$addSystem(dx5~dt/V5*((x4-x5)*(FtopOut*exp(f))+(x6-x5)*(FtopIn*exp(f)))+dt*(y5-x5)*exp(mu_x)+dw5*exp(sigma_x))
    ...
    model$addSystem(dx4~dt/V4*((x3-x4)*(FbotIn*exp(fmid))+(x5-x4)*(FbotOut*exp(fmid))-exp(u)*(S4)*x4+(Tmid-x4)*FmidIn*exp(vmid))+dt*(y4-x4)*exp(mu_xmid)+dw4*exp(sigma_x))
    model$addSystem(dx5~dt/V5*((x4-x5)*(FtopOut*exp(f))+(x6-x5)*(FtopIn*exp(f))-exp(u)*(S5)*x5)+dt*(y5-x5)*exp(mu_x1)+dw5*exp(sigma_x))
    model$addSystem(dx6~dt/V6*((x5-x6)*(FtopOut*exp(f2))+(Ttop-x6)*FtopIn*exp(vtop))+dt*(y6-x6)*exp(mu_x6)+dw6*exp(sigma_x))
    ...
    model$addSystem(dx1~dt/V1*((Tbot-x1)*FbotIn*exp(vbot)+(x2-x1)*(FbotOut*exp(fbot)))+dt*(y1-x1)*exp(mu_xbot)+dw1*exp(sigma_x))
    model$addSystem(dx2~dt/V2*((x1-x2)*(FbotIn*exp(f))+(x3-x2)*(FbotOut*exp(f)))+dt*(y2-x2)*exp(mu_x1)+dw2*exp(sigma_x))
    model$addSystem(dx3~dt/V3*((x2-x3)*(FbotIn*exp(f))+(x4-x3)*(FbotOut*exp(f)))+dt*(y3-x3)*exp(mu_x1)+dw3*exp(sigma_x))
    model$addSystem(dx4~dt/V4*((x3-x4)*(FbotIn*exp(fmid))+(x5-x4)*(FbotOut*exp(fmid))+(Tmid-x4)*FmidIn*exp(vmid))+dt*(y4-x4)*exp(mu_xmid)+dw4*exp(sigma_x))
    model$addSystem(dx5~dt/V5*((x4-x5)*(FtopOut*exp(f))+(x6-x5)*(FtopIn*exp(f)))+dt*(y5-x5)*exp(mu_x1)+dw5*exp(sigma_x))
    model$addSystem(dx6~dt/V6*((x5-x6)*(FtopOut*exp(f2))+(Ttop-x6)*FtopIn*exp(vtop))+dt*(y6-x6)*exp(mu_x6)+dw6*exp(sigma_x))
    ...
    model$addSystem(dx1~dt/V1*((Tbot-x1)*FbotIn*exp(vbot)+(x2-x1)*(FbotOut*exp(f)))+dt*(y1-x1)*exp(mu_x)+dw1*(exp(sigma_x)+FbotIn*exp(G)))
    model$addSystem(dx2~dt/V2*((x1-x2)*(FbotIn*exp(f))+(x3-x2)*(FbotOut*exp(f)))+dt*(y2-x2)*exp(mu_x)+dw2*(exp(sigma_x)+FbotIn*exp(G)))
    model$addSystem(dx3~dt/V3*((x2-x3)*(FbotIn*exp(f))+(x4-x3)*(FbotOut*exp(f)))+dt*(y3-x3)*exp(mu_x)+dw3*(exp(sigma_x)+FbotIn*exp(G)))
    model$addSystem(dx4~dt/V4*((x3-x4)*(FbotIn*exp(f))+(x5-x4)*(FbotOut*exp(f))+(Tmid-x4)*FmidIn*exp(vmid))+dt*(y4-x4)*exp(mu_x)+dw4*(exp(sigma_x)+FbotIn*exp(G)))
    model$addSystem(dx5~dt/V5*((x4-x5)*(FtopOut*exp(f))+(x6-x5)*(FtopIn*exp(f)))+dt*(y5-x5)*exp(mu_x)+dw5*(exp(sigma_x)+FtopIn*exp(G)))
    model$addSystem(dx6~dt/V6*((x5-x6)*(FtopOut*exp(f))+(Ttop-x6)*FtopIn*exp(vtop))+dt*(y6-x6)*exp(mu_x)+dw6*(exp(sigma_x)+FtopIn*exp(G)))
    ...
    model$setParameter(G = log(c(init = 1, lb = 1e-12, ub = 10)))
    ...
    model$setParameter(ftop=log(c(init=1,lb=1e-12,ub=10)))
...
old_fit <- load_model('models/2state_model3.Rdata')
